...
module fp_cbrt #(
    ...
    pade_cbrt_rom u_rom (
        .clk(clk), 
        .addr(w_fp[22:11]), // Lấy 12-bit MSB 
        .data_out(y0_rom)
    );
    ...
    // =============================================================
    // PIPELINE TÍNH SỚM PHÉP CHIA 3 VỚI GRS ROUNDING
    // =============================================================
    ...
    // T = 3 -> 4: Trích GRS Rounding từ w3_sum (chia 3)
    // Bit 35 luôn là 0. LSB ở vị trí 34 (nếu > 0.5) hoặc 33 (nếu < 0.5)
    wire norm = w3_sum[34];
    ...
    // ==========================================
    // LOGIC SCALE CHUẨN HOÁ TỪ ROM VỚI GRS ROUNDING
    // ==========================================
    ...
    // ==========================================
    // CÁC KHỐI PIPELINE MUL/FMA GIỮ NGUYÊN (26 Stages)
    // ==========================================
