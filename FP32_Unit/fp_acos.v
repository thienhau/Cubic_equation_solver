...
module fp_acos (
    ...
    shift_reg #(32, 5) dx1(clk, x_d1, x_d6); shift_reg #(32, 5) dx2(clk, x_d6, x_d11); shift_reg #(32, 5) dx3(clk, x_d11, x_d16);
    shift_reg #(1, 5) ds1(clk, s_d1, s_d6);  shift_reg #(1, 5) ds2(clk, s_d6, s_d11); shift_reg #(1, 5) ds3(clk, s_d11, s_d16);
    ...
    wire [31:0] div_dly;
    shift_reg #(32, 5) ddiv(clk, div_res, div_dly); wire s_d35; shift_reg #(1, 5) dfin(clk, s_d30, s_d35);
