...
module cardano_top #(
    ...
    wire [105:0] quad_data_out, radic_data_out, trigon_data_out;
    wire pop_quad, pop_radic, pop_trigon;

    sync_fifo_bypass #(.DATA_WIDTH(106), .DEPTH_LOG2(4)) fifo_quad (
    ...
    // T = * -> *: Mạch Arbiter ưu tiên Pop: Quad -> Radic -> Trigon
    ...
    wire [105:0] final_data = pop_quad ? quad_data_out : (pop_radic ? radic_data_out : trigon_data_out);

    assign trans_id_out = final_data[105:98];
    assign num_roots    = final_data[97:96];
    assign x1           = final_data[95:64];
    assign x2           = final_data[63:32];
    assign x3           = final_data[31:0];
