...
module tb_cardano_top();
    ...
    reg [31:0] t_a [1:10];  reg [31:0] t_b [1:10];
    reg [31:0] t_c [1:10];  reg [31:0] t_d [1:10];
    reg [1:0]  t_nr [1:10];
    reg [31:0] t_ex1 [1:10]; reg [31:0] t_ex2 [1:10]; reg [31:0] t_ex3 [1:10];

    initial begin
        // ID 1: Bậc 2 (Quad - Trễ 48)
        ...
        // ID 3: Bậc 3 Lượng giác (Trigon - Trễ 121)
        ...
        // ID 4: Bậc 3 Lượng giác (Trigon - Trễ 121)
        ...
        // ID 5: Bậc 3 Lượng giác (Trigon - Trễ 121)
        t_a[5] = 32'h40000000; t_b[5] = 32'hC0800000; t_c[5] = 32'hC1B00000; t_d[5] = 32'h41C00000;
        t_nr[5] = 3; t_ex1[5] = 32'h40400000; t_ex2[5] = 32'h3F800000; t_ex3[5] = 32'hC0800000;

        // ID 6: Bậc 3 Lượng giác (Trigon - Trễ 121)
        ...
        // ID 7: Bậc 3 Căn bậc (Radic - Trễ 56)
        t_a[7] = 32'h3F800000; t_b[7] = 32'h00000000; t_c[7] = 32'h00000000; t_d[7] = 32'hC1000000;
        t_nr[7] = 1; t_ex1[7] = 32'h40000000; t_ex2[7] = 0; t_ex3[7] = 0;

        // ID 8: Bậc 3 Căn bậc (Radic - Trễ 56)
        t_a[8] = 32'h3F800000; t_b[8] = 32'h00000000; t_c[8] = 32'h00000000; t_d[8] = 32'h3F800000;
        t_nr[8] = 1; t_ex1[8] = 32'hBF800000; t_ex2[8] = 0; t_ex3[8] = 0;

        // ID 9: Bậc 3 Căn bậc (Radic - Trễ 56)
        t_a[9] = 32'h3F800000; t_b[9] = 32'hC0400000; t_c[9] = 32'h40400000; t_d[9] = 32'hC1100000;
        t_nr[9] = 1; t_ex1[9] = 32'h40400000; t_ex2[9] = 0; t_ex3[9] = 0;

        // ID 10: Bậc 3 Căn bậc (Radic - Trễ 56)
        t_a[10] = 32'h3F800000; t_b[10] = 32'h3F800000; t_c[10] = 32'h3F800000; t_d[10] = 32'hC0400000;
        t_nr[10] = 1; t_ex1[10] = 32'h3F800000; t_ex2[10] = 0; t_ex3[10] = 0;
    end
